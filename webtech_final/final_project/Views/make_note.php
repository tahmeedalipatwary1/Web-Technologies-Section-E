...
require_once('../Models/makeNote_db.php');
$conn=getConnection();
...
if (isset($_GET['delete'])) {
    ...
    $sql = "delete from notes where id = $noteId AND username = '$username'";
    $res = mysqli_query($conn, $sql);
    if ($res) {
...
<body>
    <header>
        ...
        <div id="dropdownMenu" class="dropdown-content">
            ...
            <a href="../Controllers/recommendation_controller.php">service</a>
...
<table>
    <?php foreach ($notes as $note): ?>
        <tr>
            <td>Note: <?php echo htmlspecialchars($note['note']); ?></td>
            <td>Action: <a href="?delete=<?php echo $note['id']; ?>">Delete</a></td>
        </tr>
    <?php endforeach; ?>
</table>
<br>
...
<br>
<br>
<form method="post" action="make_note.php">
    <textarea name="note"></textarea>
    <input type="submit" name="submit_note" value="Submit">
</form>
